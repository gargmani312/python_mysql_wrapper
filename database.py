...
class Database:
    ...
    def get_all_as_set(
        self, table=None, fields=None, where=None, order=None, limit=None
    ):
        """Get all results
    ...
    def leftJoin(
        self, tables=(), fields=(), join_fields=(), where=None, order=None, limit=None
    ):
    ...
    def insertOrUpdate(self, table, data, keys):
        ...
        return self.query(
            sql, list(insert_data.values()) + list(data.values())
        ).rowcount
